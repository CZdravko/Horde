...
struct IK_Param
{
	enum List
	{
		...
		lEyeDfltRotX_F,					///< the rotation parameters for the default rotation (looking forward) of the left eye
		lEyeDfltRotY_F,					///< the rotation parameters for the default rotation (looking forward) of the left eye
		lEyeDfltRotZ_F,					///< the rotation parameters for the default rotation (looking forward) of the left eye
		rEyeDfltRotX_F,					///< the rotation parameters for the default rotation (looking forward) of the right eye
		rEyeDfltRotY_F,					///< the rotation parameters for the default rotation (looking forward) of the right eye
		rEyeDfltRotZ_F,					///< the rotation parameters for the default rotation (looking forward) of the right eye
		_EndParamF,						///< must always be the last float paramater

		lEyeHorizAxis_S,				///< the horizontal axis of the left eye
		rEyeHorizAxis_S,				///< the horizontal axis of the right eye
