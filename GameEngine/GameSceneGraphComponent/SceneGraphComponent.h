...
private:
	...
	float				m_net_lasttransformation[16];
	float				m_net_traject_speedup;
	Vec3f				m_net_traject_translation;
	Vec3f				m_net_traject_rotation;
	Vec3f				m_net_traject_scale;
	bool				m_net_applyTrajection;
	float				m_net_maxTrajection;
};
#endif